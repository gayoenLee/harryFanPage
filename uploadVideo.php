...
<div class="login-page">
  <div class="form">
      ...
      <p class="message"><h3>동영상 업로드</h3></p>
<!-- 업로드 버튼 눌러서 동영상 추가하기 -->
<form class="login-form" action='uploadVideoProcess.php' method='post'>
...
<button><input type="submit" name="submit"value="동영상 업로드하기"></button>
</form>
</p>
</div>
</div>
